...
## Prepare annotation
id_text <- data.frame(x = 1.5, y = 0.75, lab = "Index sequence: N.S.")
...
df12$test_category2[df12$test_category2 == cat2[4]] <- "1st-indexing, Platinum"
df12$test_category2[df12$test_category2 == cat2[5]] <- "4-µl"
df12$test_category2[df12$test_category2 == cat2[6]] <- "1-rep."
df12$test_category2[df12$test_category2 == cat2[7]] <- "8-µl"
...
df12$test_category2[df12$test_category2 == cat2[12]] <- "8-rep."
df12$test_category2[df12$test_category2 == cat2[13]] <- "2nd-indexing, Platinum"
### Re-import df12
...
df13$test_category2[df13$test_category2 == cat3[1]] <- "1st PCR indexing, w/o exonuclease"
df13$test_category2[df13$test_category2 == cat3[2]] <- "2nd PCR indexing, w/o exonuclease"
df13$test_category2[df13$test_category2 == cat3[3]] <- "1st PCR indexing, w exonuclease"
