####
#### No.10.2 Rarefying sequence depth and compare diversity
#### R 4.1.2
####
...
ps_exp3_site1 <- prune_samples(sample_names(ps_exp3) != "E03_T001_S001", ps_exp3) %>%
...
ps_exp3_site2 <- prune_samples(sample_names(ps_exp3) != "E03_T001_S001", ps_exp3) %>%
...
#plot_grid(f2, plot_richness(ps_exp3_even, measures = "Observed"),
#          ncol = 2, rel_widths = c(1,0.7))
#dev.off()
#ggsave(file = sprintf("%s/SummaryReads.pdf", output_folder), plot = f3, width = 12, height = 12)
#ggsave(file = sprintf("%s/STDsummary_Reads1.pdf", output_folder), plot = f4, width = 12, height = 12)
#ggsave(file = sprintf("%s/STDsummary_Reads2.pdf", output_folder), plot = f5, width = 12, height = 12)
#ggsave(file = sprintf("%s/Diversity_Even.pdf", output_folder), plot = f6, width = 6, height = 6)
#ggsave(file = sprintf("%s/SeaN_Diversity.pdf", output_folder), plot = f3_1, width = 10, height = 6)
#ggsave(file = sprintf("%s/StdM_Diversity.pdf", output_folder), plot = f3_2, width = 10, height = 6)
#ggsave(file = sprintf("%s/SeaN_Diversity1.pdf", output_folder), plot = d1_1, width = 10, height = 6)
#ggsave(file = sprintf("%s/SeaN_Diversity2.pdf", output_folder), plot = d1_2, width = 10, height = 6)
#ggsave(file = sprintf("%s/StdM_Diversity1.pdf", output_folder), plot = d2_1, width = 10, height = 6)
#ggsave(file = sprintf("%s/StdM_Diversity2.pdf", output_folder), plot = d2_2, width = 10, height = 6)
